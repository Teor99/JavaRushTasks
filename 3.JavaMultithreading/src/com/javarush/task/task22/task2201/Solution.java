    ...
    public synchronized String getPartOfString(String string, String threadName) {
        ...
        try {
            ...
            if (threadName.equals(FIRST_THREAD_NAME)) {
                StringForFirstThreadTooShortException newEx = new StringForFirstThreadTooShortException();
                newEx.initCause(e);
                throw newEx;
            } else if (threadName.equals(SECOND_THREAD_NAME)) {
                StringForSecondThreadTooShortException newEx = new StringForSecondThreadTooShortException();
                newEx.initCause(e);
                throw newEx;
            } else {
